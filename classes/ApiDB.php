...
class ApiDB
{
     ...
     */
    public function __construct($host = null, $username = null, $password = null, $ApiDB = null, $port = null, $charset = 'utf8', $socket = null)
    {
        $isSubQuery = false;
    ...
    public function connect()
    {
        ...
        $this->_mysqli = new mysqli($this->host, $this->_username, $this->_password, $this->ApiDB, $this->port, $this->socket);
     ...
     *
     * @uses $ApiDB = ApiDB::getInstance();
     *
     * @return ApiDB Returns the current instance.
     */
    ...
    /**
     * Helper function to create ApiDBObject with JSON return type
     *
     * @return ApiDB
     */
    ...
    /**
     * Helper function to create ApiDBObject with array return type
    ...
    /**
     * Helper function to create ApiDBObject with object return type.
     *
     * @return ApiDB
     */
     ...
     *
     * @uses $ApiDB->setQueryOption('name');
     *
     ...
     * @param array $insertData Data containing information for inserting into the ApiDB.
     *
     ...
     *
     * @param string $tableName The name of the table.
     * @param array $multiInsertData Two-dimensinal Data-array containing information for inserting into the ApiDB.
     ...
     *
     * @uses $ApiDB->where('id', 7)->where('title', 'MyTitle');
     *
     ...
     * @return ApiDB
     */
    public function where($whereProp, $whereValue = 'ApiDBNULL', $operator = '=', $cond = 'AND')
    {
     ...
     *
     * @uses $ApiDB->orWhere('id', 7)->orWhere('title', 'MyTitle');
     *
     * @param string $whereProp  The name of the database field.
     * @param mixed  $whereValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     * @return ApiDB
     */
    public function orWhere($whereProp, $whereValue = 'ApiDBNULL', $operator = '=')
    {
    ...
    public function having($havingProp, $havingValue = 'ApiDBNULL', $operator = '=', $cond = 'AND')
    {
        // forkaround for an old operation api
     ...
     *
     * @uses $ApiDB->orHaving('SUM(tags) > 10')
     *
     * @param string $havingProp  The name of the database field.
     * @param mixed  $havingValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     *
     * @uses $ApiDB->join('table1', 'field1 <> field2', 'LEFT')
     *
     ...
     *
     * @uses $ApiDB->orderBy('id', 'desc')->orderBy('name', 'desc', '^[a-z]')->orderBy('name', 'desc');
     *
    ...
    /**
     * Method creates new ApiDB object for a subquery generation
     *
    ...
    /**
     * Method returns a copy of a ApiDB subquery object
     *
     * @return ApiDB new ApiDB object
     */
    ...
    /**
     * Get where and what function was called for query stored in ApiDB->trace
     *
    ...
    public function tableExists($tables)
    {
        ...
        $this->where('table_schema', $this->ApiDB);
     ...
     *
     * @uses $ApiDBWrapper->joinWhere('user u', 'u.id', 7)->where('user u', 'u.title', 'MyTitle');
     *
     ...
     * @return ApiDBWrapper
     */
    public function joinWhere($whereJoin, $whereProp, $whereValue = 'ApiDBNULL', $operator = '=', $cond = 'AND')
    {
     ...
     * @return ApiDBWrapper
     */
    public function joinOrWhere($whereJoin, $whereProp, $whereValue = 'ApiDBNULL', $operator = '=', $cond = 'AND')
    {
