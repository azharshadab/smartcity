...
//$chart_data = $solar_data->getSolarData();

//$columns = array(
//    array( 'db' => 'status', 'dt' => 0),
//    array( 'db' => 'image', 'dt' => 1),
//    array( 'db' => 'house_number', 'dt' => 2),
//    array( 'db' => 'power_now',    'dt' => 3 ),
//    array( 'db' => 'total_energy', 'dt' => 4 ),
//    array(
//        'db' => 'created_date',
//        'dt' => 5,
//        'formatter' => function( $d, $row ) {
//            return ($d == null) ? '-':date( 'd-m-Y H:i:s A', strtotime($d));
//        }
//    )
//);
//
...
//$i = 0;
//
//foreach ($ad->data as $a) {
//    preg_match("/[0-9\.]*/", $a[3], $a1);
//    preg_match("/[0-9\.]*/", $a[4], $a2);
//
//    $kw = $kw + $a1[0];
//    $kwh = $kwh + $a2[0];
//
//    $return['data'][$i]['status'] = "http://www.omnikportal.com/images/".$a[0];
//    $return['data'][$i]['house_image'] = "http://www.omnikportal.com/images/UserImages/".$a[1];
//    $return['data'][$i]['house_number'] = $a[2];
//    //$return['data'][$i]['power_now'] = $a[1];
//    //$return['data'][$i]['total_energy'] = $a[2];
//    $return['data'][$i]['power_now'] = $a1[0] + 0;
//    $return['data'][$i]['total_energy'] = $a2[0];
//    $t1 = str_replace(' PM', '', $a[5]);
//    $return['data'][$i]['update_time'] = str_replace(' AM', '', $t1);
//
//    $i++;
//}

$return['total_power_now'] = "550";
$return['grand_total_energy'] = "53421";
$return['date'] = date("d-m-Y h:i:s A");
